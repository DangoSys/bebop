...
//!
//! Usage:
//!   cargo test --test test_verilator --features verilator -- --help
//!   cargo test --test test_verilator --features verilator
//!   cargo test --test test_verilator --features verilator -- --filter matmul
