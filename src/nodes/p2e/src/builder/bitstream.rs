...
/// Bitstream builder
///
/// `build_dir` contains the design build artifacts (vvacDir) generated by `cargo build`.
/// `output_dir` is where bitstream and synthesis logs are written.
...
impl BitstreamBuilder {
    pub fn new(build_dir: PathBuf, output_dir: PathBuf) -> Self {
