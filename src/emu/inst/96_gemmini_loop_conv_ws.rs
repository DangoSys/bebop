...
use super::decode::{
    FUNCT_GEMMINI_LOOP_CONV_WS_CONFIG_1, FUNCT_GEMMINI_LOOP_CONV_WS_CONFIG_2,
    FUNCT_GEMMINI_LOOP_CONV_WS_CONFIG_3, FUNCT_GEMMINI_LOOP_CONV_WS_CONFIG_4,
    FUNCT_GEMMINI_LOOP_CONV_WS_CONFIG_5, FUNCT_GEMMINI_LOOP_CONV_WS_CONFIG_6,
    FUNCT_GEMMINI_LOOP_CONV_WS_CONFIG_7, FUNCT_GEMMINI_LOOP_CONV_WS_CONFIG_8,
